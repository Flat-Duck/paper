...
<div class="container-xl">
    <div class="page-header d-print-none">
        <h2 class="page-title">@lang('crud.dashboard')</h2>
    </div>
</div>
<div class="page-body">
    <div class="container-xl">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="text-secondary">
                                           {{App\Models\User::where('is_teacher',true)->count()}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">
                                            عدد تحميلات الاوراق العلمية
                                        </div>
                                        <div class="text-secondary">
                                            {{App\Models\Paper::all()->sum('downloads')}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="text-secondary">
                                            {{App\Models\Book::all()->sum('downloads')}}
                                        </div>
                                    </div>
                                </div>
                            </div>
