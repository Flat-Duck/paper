            ...
            <div class="navbar-header">
                ...
                <a class="a-icon-logo navbar-brand" href="/">
                    <img width="40px" height="40px" title="Noor Book" alt="Noor Book" class="icon-logo"
                        src="/publice/images/nooricon.svg">
                </a>
            </div>
