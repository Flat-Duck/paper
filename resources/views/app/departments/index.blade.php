@extends('layouts.app', ['page' => 'crud.departments.index_title'])

@section('title', trans('crud.departments.index_title') )
@section('content')
<div class="container-xl">
    <div class="page-header d-print-none">
        <h2 class="page-title">@lang('crud.departments.index_title')</h2>
    </div>
</div>
<div class="page-body">
    <div class="container-xl">
        <div class="card">
            ...
            <div class="table-responsive">
                ...
                >
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>@lang('crud.departments.inputs.name')</th>
            ...
            <div class="card-footer pb-0">{{ $departments->links() }}</div>
            @endif
        </div>
    </div>
</div>
